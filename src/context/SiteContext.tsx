...
export const DEFAULT_SITE_SETTINGS: SiteSettings = {
  ...
  services: {
    ...
    title: 'Our Services',
    headline: 'Structured Education, Market Insights & Professional Mentorship',
    subtitle: 'At USH Forex Academy & Community of Traders, we provide structured education, market insights, mentorship, and professional consultation designed to help traders develop the knowledge, discipline, and skills required to navigate the financial markets.',
    services: [
      {
        id: 'service-1',
        number: '01',
        title: 'Forex Education & Training',
        subtitle: 'Build the knowledge and skills to trade with confidence.',
        description: 'We offer structured forex education for both beginners and experienced traders, covering the fundamentals of the market through advanced trading concepts.',
        includedTitle: "What’s included:",
        inclusions: [
          'Beginner & advanced trading classes',
      ...
      },
      {
        id: 'service-2',
        number: '02',
        title: '3-Month Mentorship & Membership',
        subtitle: 'Learn, practice, and grow with experienced traders.',
        description: 'Our 3-month mentorship and membership program provides a structured learning environment where members receive education, guidance, market insights, and ongoing support throughout their development as traders.',
        includedTitle: 'Members can receive:',
        inclusions: [
          '3 months of structured mentorship',
          'Beginner and advanced learning sessions',
          'Trading guidance and practical lessons',
          'Community access and peer interaction',
          'Market analysis and educational breakdowns',
          'Trading psychology and risk-management guidance',
          'Support throughout the learning journey',
        ],
        badge: 'Flagship Mentorship',
        icon: 'Crown',
      ...
      },
      {
        ...
        inclusions: [
          ...
          'Stop-loss guidance',
          'Take-profit targets',
          'Market analysis and trade rationale',
        ],
        disclaimer: 'Important: Signals are provided for educational and informational purposes. No trading signal is guaranteed to be profitable. Members should apply proper risk management and make their own trading decisions.',
        badge: 'Free Signals',
        icon: 'Zap',
        ctaText: 'Access Free Signals',
      },
      {
        id: 'service-4',
        number: '04',
        title: 'Professional Investment Consultation',
        subtitle: 'Strategic guidance for investors considering larger trading allocations.',
        description: 'For individuals and investors interested in making substantial investments in the financial markets, USH offers professional consultation focused on understanding objectives, risk tolerance, trading strategy, and capital-management considerations.',
        includedTitle: 'Consultation may cover:',
        inclusions: [
          'Investment and trading objectives',
          'Capital allocation considerations',
          'Risk-management planning',
          'Trading strategy evaluation',
          'Portfolio and exposure considerations',
          'Market opportunities and risks',
          'Personalized trading guidance',
        ],
        disclaimer: 'Investment consultation does not guarantee returns or eliminate the risk of loss.',
      ...
      },
      {
        id: 'service-5',
        number: '05',
        title: 'Advanced Trader Development',
        subtitle: 'Take your trading beyond the basics.',
        description: 'For traders who already have market experience, our advanced training focuses on improving consistency, analytical ability, execution, and risk management.',
        includedTitle: 'This can include:',
        inclusions: [
        ...
        badge: 'Pro Development',
        icon: 'TrendingUp',
        ctaText: 'Elevate Your Trading',
      },
      {
        id: 'service-6',
        number: '06',
        title: 'Community & Trader Support',
        subtitle: 'You don’t have to learn alone.',
        description: 'Our trading community brings together individuals at different stages of their trading journey, creating an environment for learning, discussion, market analysis, and continuous development.',
        includedTitle: 'Community benefits may include:',
        inclusions: [
          'Trader discussions',
          'Educational content',
          'Market updates',
